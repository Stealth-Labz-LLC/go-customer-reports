...
$ctaLink = 'https://buy.evergreenessentials.co.za/vl-es-1/int/checkout.php?coupon=SWXP50&affId=stlnwk&c1=quiz' . $queryParams;
?>
	        ...
	        <div class="row mb-3">
				...
				<div class="quiz-slide hidden" id="cta-slide">
					<div class="container">
						...
						<p class="narrow">You've been selected to receive a <span class="discount-text">50% off discount</span>! Click below to claim your discount and learn more VitaLean today.<</p>
						</div></div>
						<div class="row mb-1"><div class="col">
						<a href="<?php echo $ctaLink; ?>"><img src="images/1-bottle-vitalean.png" alt="1 Bottle Discount" class="img-fluid" /></a>
						</div></div>
						<div class="row mb-1">
