...
function sendToWebhook($data, $campaign, $extraFields = []) {
    ...
    $payload = [
        ...
        'consent_text' => 'By pressing "Claim My Free Consultation Now" you agree to our privacy policy and consent to have an agent from one of our partners contact you by email, phone call, or text/SMS message at the phone number and email you provide. Consent isn\'t a condition to purchase our products.',
