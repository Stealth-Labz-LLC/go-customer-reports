    ...
    <div class="wrapper">
        <div class="main">
            ...
            <div class="intro-slide">
                ...
                <button class="start-btn btn btn-dark answer-tight">YES</button>
                <button class="next-btn btn btn-dark answer-tight">NO</button>
                <div>
                    <img loading="lazy" class="trust-logos" src="images/as-seen-on.png" alt="">
                </div>
            </div>
            <!-- Question 1 -->
            ...
            <div class="quiz-slide hidden" id="cta-slide">
                <div class="container">
                    ...
                    <div class="row mb-1">
                        <div class="col">
                            <p class="narrow">Based on your answers, you are likely eligible to <strong>end your solar contract</strong>. You may even receive a settlement from the solar sales company for gross misrepresentation.</p>
                        </div>
                    </div>
